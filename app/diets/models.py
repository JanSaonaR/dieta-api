...
class Diet:
    ...
    def get_3_almuerzo(self):
        ...
        if self.child.calories > 0.0:
            ...
            dt_almuerzo = dt_almuerzo[(
                dt_almuerzo['Cumple_Requisitos'] == True)]
    ...
    def get_cena(self):
        ...
        return dt_cena[['Alimento', 'Proteinas', 'Grasas', 'Carbohidratos',
                        'Cantidad_Gramos_Consumir', 'Total_Calorias',
                        'Ingredientes', 'Nivel_Preferencia', 'Image_url']]
